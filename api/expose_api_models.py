...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.DogWalker, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.WalkLocation, method_decorators= method_decorators)

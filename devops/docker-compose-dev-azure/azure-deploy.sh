...
resourcename="walkies-r-usiter1"  # lower case, only
resourcegroup="walkies-r-usiter1_rg"
...
# git clone https://github.com/apilogicserver/walkies-r-usiter1.git
# cd walkies-r-usiter1
...
az group create --name walkies-r-usiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group walkies-r-usiter1_rg --sku S1 --is-linux
az container create --resource-group walkies-r-usiter1_rg --name walkies-r-usiter1 --image apilogicserver/walkies-r-usiter1:latest --dns-name-label walkies-r-usiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//walkies-r-usiter1.westus.azurecontainer.io:5656'

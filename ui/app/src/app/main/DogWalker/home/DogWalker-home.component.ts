...
@Component({
  selector: 'DogWalker-home',
  templateUrl: './DogWalker-home.component.html',
  styleUrls: ['./DogWalker-home.component.scss']
})
export class DogWalkerHomeComponent implements AfterViewInit {

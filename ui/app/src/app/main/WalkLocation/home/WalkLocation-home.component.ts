...
@Component({
  selector: 'WalkLocation-home',
  templateUrl: './WalkLocation-home.component.html',
  styleUrls: ['./WalkLocation-home.component.scss']
})
export class WalkLocationHomeComponent implements AfterViewInit {
